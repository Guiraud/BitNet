...
#include "./inductor-cache/pi/cpicxudqmdsjh5cm4klbtbrvy2cxwr7whxl3md2zzdjdf3orvfdf.h"
                       ...
                       half* out_ptr1)
{
    #pragma omp parallel num_threads(8)
    {
        int tid = omp_get_thread_num();
        {
            ...
            {
                for(int64_t x1=static_cast<int64_t>(0LL); x1<static_cast<int64_t>(6912LL); x1+=static_cast<int64_t>(1LL))
                {
                    {
                        {
                            auto tmp0 = x0;
                            ...
                            auto tmp7 = [&]
                            {
                                auto tmp8 = in_ptr0[static_cast<int64_t>((-8847360LL) + x1 + 6912LL*x0)];
                            ...
                            auto tmp18 = [&]
                            {
                                auto tmp19 = in_ptr0[static_cast<int64_t>((-4423680LL) + x1 + 6912LL*x0)];
                            ...
                            auto tmp26 = [&]
                            {
                                auto tmp27 = in_ptr0[static_cast<int64_t>(x1 + 6912LL*x0)];
                            ...
                            auto tmp38 = [&]
                            {
                                auto tmp39 = in_ptr0[static_cast<int64_t>((-13271040LL) + x1 + 6912LL*x0)];
                            ...
                            auto tmp49 = c10::convert<half>(tmp48);
                            out_ptr1[static_cast<int64_t>(x1 + 6912LL*x0)] = tmp49;
                        }
                    }
                }
            }
...
static PyObject* kernel_py(PyObject* self, PyObject* args) {
    try {
        ...
        kernel(parse_arg<uint8_t*>(args, 0), parse_arg<half*>(args, 1)); Py_RETURN_NONE;
