...
def call(args):
    arg0_1, = args
    args.clear()
    assert_size_stride(arg0_1, (1, 42, 2560), (107520, 2560, 1))
    with torch._ops.contextlib.nullcontext():
        # MPS set device
        buf2 = empty_strided((1, 42, 2560), (107520, 2560, 1), device='mps', dtype=torch.float16)
        mps_lib_0.generated_kernel(buf2, arg0_1, threads=[42, 1024], group_size=[1, 1024])
        del arg0_1
    return (buf2, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 42, 2560), (107520, 2560, 1), device='mps:0', dtype=torch.float16)
