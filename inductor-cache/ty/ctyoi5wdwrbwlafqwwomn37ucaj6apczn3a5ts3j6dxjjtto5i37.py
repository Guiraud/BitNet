...
def call(args):
    ...
    with torch._ops.contextlib.nullcontext():
        # MPS set device
        buf2 = empty_strided((1, 34, 2560), (87040, 2560, 1), device='mps', dtype=torch.float16)
        mps_lib_0.generated_kernel(buf2, arg0_1, threads=[34, 1024], group_size=[1, 1024])
        del arg0_1
    return (buf2, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 34, 2560), (87040, 2560, 1), device='mps:0', dtype=torch.float16)
