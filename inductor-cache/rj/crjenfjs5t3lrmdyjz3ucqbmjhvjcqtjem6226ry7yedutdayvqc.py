...
cpp_fused___rshift____to_copy_bitwise_and_sub_zeros_0 = async_compile.cpp_pybinding(['const uint8_t*', 'half*', 'const int64_t', 'const int64_t'], '''
...
def call(args):
    ...
    buf1 = empty_strided_cpu((4*s0, s1), (s1, 1), torch.float16)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 1728
    arg1_1 = 2560
    arg2_1 = rand_strided((1728, 2560), (2560, 1), device='cpu', dtype=torch.uint8)
