...
cpp_fused___rshift____to_copy_bitwise_and_sub_zeros_0 = async_compile.cpp_pybinding(['const uint8_t*', 'float*'], '''
...
def call(args):
    ...
    buf1 = empty_strided_cpu((2560, 6912), (6912, 1), torch.float32)
